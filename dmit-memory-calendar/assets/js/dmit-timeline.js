...
( function () {
	...
	function initTimeline( wrap ) {
		...
		var emptyMessage = wrap.getAttribute( 'data-empty-message' ) || ( window.dmitMC ? window.dmitMC.i18n.noEvents : '' );

		var url = new URL( window.dmitMC.restUrl + '/on-this-day' );
		if ( month ) {
		...
		wrap.innerHTML = '<p class="rl-loading">' + escapeHtml( window.dmitMC.i18n.loading ) + '</p>';
